...
function Navbar() {
  ...
  return (
    <>
      <div className=" py-8 fixed top-24 w-full z-50 bg-gradient-to-b from-black via-black/90 via-50% to-transparent">
        <nav className="bg-black py-4 fixed top-0 w-full z-50 ">
